...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_4x6_5(
        ...
        KC_ESC, KC_K,    KC_H,    KC_C,    KC_D,    KC_W,             KC_Z, KC_U,    KC_O,    KC_Y,    KC_Q,    KC_BSLS,
        KC_TAB, LCTL_T(KC_L),    LALT_T(KC_N),    LGUI_T(KC_S),    LSFT_T(KC_T),    KC_G,             KC_J, LSFT_T(KC_A),    LGUI_T(KC_E),    LALT_T(KC_I),    LCTL_T(KC_P),    KC_LSFT,
        KC_CAPS, KC_V,    KC_B,    KC_F,    KC_M,    KC_X,             KC_MINS, KC_QUOT,  KC_COMM, KC_DOT, KC_SLSH,  KC_TRNS,
